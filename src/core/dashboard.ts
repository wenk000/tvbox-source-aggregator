...
@media(max-width:560px){
  ...
  .health-table{font-size:0.95rem}
...
<div class="container">
  ...
  <div class="config-section">
    ...
    <div style="margin-top:12px">
      <div class="config-label" data-i18n="configJsonUrlLabel">Config JSON (Download)</div>
      <div class="config-url-row">
        <div class="config-url" id="configJsonUrl"></div>
        <button class="copy-btn" id="copyConfigJsonBtn" onclick="copyUrl('configJsonUrl')" data-i18n="copy">Copy</button>
      </div>
    </div>
    <div style="margin-top:12px">
    ...
    <div style="margin-top:12px">
      <div class="config-label" data-i18n="liveJsonUrlLabel">Live JSON (Download)</div>
      <div class="config-url-row">
        <div class="config-url" id="liveJsonUrl"></div>
        <button class="copy-btn" id="copyLiveJsonBtn" onclick="copyUrl('liveJsonUrl')" data-i18n="copy">Copy</button>
      </div>
    </div>
  </div>
...
const translations = {
  en: {
    ...
    configUrlLabel:'TVBox Config URL', configJsonUrlLabel:'Config JSON (Download)', liveConfigUrlLabel:'Live-Only Config URL', liveJsonUrlLabel:'Live JSON (Download)',
  ...
  zh: {
    ...
    configUrlLabel:'TVBox 配置地址', configJsonUrlLabel:'配置 JSON（下载）', liveConfigUrlLabel:'直播配置地址', liveJsonUrlLabel:'直播 JSON（下载）',
...
const configJsonUrl = location.origin + '/index.json';
const liveConfigUrl = location.origin + '/live-config';
const liveJsonUrl = location.origin + '/live.json';
$('configUrl').textContent = configUrl;
$('configJsonUrl').textContent = configJsonUrl;
$('liveConfigUrl').textContent = liveConfigUrl;
$('liveJsonUrl').textContent = liveJsonUrl;
